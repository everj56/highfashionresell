...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20241130_highfashionresell_7382437664957d363500_20241130104631_archive.zip';
        const ARCHIVE_SIZE       = '150577563';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '7382437-30104631';
        const SECONDARY_PACKAGE_HASH = '5761250-30104631';
